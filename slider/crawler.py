...
from utils import Colors as clr # pylint: disable=E0611
...
class Crawler:
    ...
    def prepare_for_upload(self, path, filename, file_ending, url):
        ...
        if float(file_size) >= 3E8: #2E8: 200.000.000 byte; 5E7: 30MB
            print('{}file_skiped:{} {}'.format(clr.BLUE, clr.ENDC, display_path))
